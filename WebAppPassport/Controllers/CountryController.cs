...
public class CountryController(ICountryService countryService) : ControllerBase
{
    ...
    public async Task<ActionResult<List<CountryListItemViewModel>>> GetAll()
    {
    ...
    public async Task<ActionResult<CountryDetailViewModel>> GetDetail(string isoShortCode)
    {
